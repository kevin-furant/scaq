...
workflow aligner_workflow {
    ...
    Map[String, Array[Int, Int]] sample_gpu_groups = as_map(cross(samples, gpu_ids))
    ...
    scatter(sample in samples){
        call sample_aligner {
            input:
                ...
                gpu_group = sample_gpu_groups[sample]
        }
    }
    output {
        Array[File] all_bams = sample_aligner.out_bam
        Array[File] all_bais = sample_aligner.out_bai
        Array[File] all_bam_stats = sample_aligner.bam_stat
    }
}
